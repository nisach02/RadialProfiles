...
results = pd.read_csv('/Users/nischal/Desktop/PhD/FinalCigaleChecks/CigaleOut/XrayReffV3RemovedBig.csv')
...
# %% ssfr
#xray SSFR
shell1ssfr = np.log10(shell1['bayes.sfh.sfr']/shell1['bayes.stellar.m_star']/shell1area).dropna()
shell2ssfr = np.log10(shell2['bayes.sfh.sfr']/shell2['bayes.stellar.m_star']/shell2area).dropna()
shell3ssfr = np.log10(shell3['bayes.sfh.sfr']/shell3['bayes.stellar.m_star']/shell3area).dropna()
shell4ssfr = np.log10(shell4['bayes.sfh.sfr']/shell4['bayes.stellar.m_star']/shell4area).dropna()
shell5ssfr = np.log10(shell5['bayes.sfh.sfr']/shell5['bayes.stellar.m_star']/shell5area).dropna()
shell6ssfr = np.log10(shell6['bayes.sfh.sfr']/shell6['bayes.stellar.m_star']/shell6area).dropna()
shell7ssfr = np.log10(shell7['bayes.sfh.sfr']/shell7['bayes.stellar.m_star']/shell7area).dropna()
...
#control SFR
control1ssfr = np.log10(control1['bayes.sfh.sfr']/control1['bayes.stellar.m_star']/control1area).dropna()
control2ssfr = np.log10(control2['bayes.sfh.sfr']/control2['bayes.stellar.m_star']/control2area).dropna()
control3ssfr = np.log10(control3['bayes.sfh.sfr']/control3['bayes.stellar.m_star']/control3area).dropna()
control4ssfr = np.log10(control4['bayes.sfh.sfr']/control4['bayes.stellar.m_star']/control4area).dropna()
control5ssfr = np.log10(control5['bayes.sfh.sfr']/control5['bayes.stellar.m_star']/control5area).dropna()
control6ssfr = np.log10(control6['bayes.sfh.sfr']/control6['bayes.stellar.m_star']/control6area).dropna()
control7ssfr = np.log10(control7['bayes.sfh.sfr']/control7['bayes.stellar.m_star']/control7area).dropna()

#composite SSFR
composite1ssfr = np.log10(composite1['bayes.sfh.sfr']/composite1['bayes.stellar.m_star']/composite1area).dropna()
composite2ssfr = np.log10(composite2['bayes.sfh.sfr']/composite2['bayes.stellar.m_star']/composite2area).dropna()
composite3ssfr = np.log10(composite3['bayes.sfh.sfr']/composite3['bayes.stellar.m_star']/composite3area).dropna()
composite4ssfr = np.log10(composite4['bayes.sfh.sfr']/composite4['bayes.stellar.m_star']/composite4area).dropna()
composite5ssfr = np.log10(composite5['bayes.sfh.sfr']/composite5['bayes.stellar.m_star']/composite5area).dropna()
composite6ssfr = np.log10(composite6['bayes.sfh.sfr']/composite6['bayes.stellar.m_star']/composite6area).dropna()
composite7ssfr = np.log10(composite7['bayes.sfh.sfr']/composite7['bayes.stellar.m_star']/composite7area).dropna()

#starforming SSFR
starforming1ssfr = np.log10(starforming1['bayes.sfh.sfr']/starforming1['bayes.stellar.m_star']/starforming1area).dropna()
starforming2ssfr = np.log10(starforming2['bayes.sfh.sfr']/starforming2['bayes.stellar.m_star']/starforming2area).dropna()
starforming3ssfr = np.log10(starforming3['bayes.sfh.sfr']/starforming3['bayes.stellar.m_star']/starforming3area).dropna()
starforming4ssfr = np.log10(starforming4['bayes.sfh.sfr']/starforming4['bayes.stellar.m_star']/starforming4area).dropna()
starforming5ssfr = np.log10(starforming5['bayes.sfh.sfr']/starforming5['bayes.stellar.m_star']/starforming5area).dropna()
starforming6ssfr = np.log10(starforming6['bayes.sfh.sfr']/starforming6['bayes.stellar.m_star']/starforming6area).dropna()
starforming7ssfr = np.log10(starforming7['bayes.sfh.sfr']/starforming7['bayes.stellar.m_star']/starforming7area).dropna()
...
plt.xlabel('R/Re')
plt.ylabel("sSFR Density log[yr$^{_-1}$kpc$^{_-2}$]")
plt.xticks(reff)
plt.show()
